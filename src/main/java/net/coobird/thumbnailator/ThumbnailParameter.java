...
public class ThumbnailParameter {
     ...
     * The thumbnail size.
     * <p>&nbsp;</p>
     * If this field is set, then the {@link #widthScalingFactor} field will be set
     ...
     */
    public double widthScalingFactor;
     ...
     * as {@code null} to indicate that it is not set.
     */
    public double heightScalingFactor;
     ...
     * @param heightScalingFactor height scalling factor
     * @param widthScalingFactor  width scalling factor
     */
    public static void validateScalingFactor(double widthScalingFactor, double heightScalingFactor) {
    ...
    public ThumbnailParameter(
        ...
        validateScalingFactor(widthScalingFactor, heightScalingFactor);
    }
