...
public class PipelineTest {
    ...
    public void singleFilter_ArrayConstructor() {
        ...
        // then
        verify(filter1).apply(Mockito.any(BufferedImage.class));
    }
    ...
    public void singleFilter_ListConstructor() {
        ...
        Pipeline pipeline = new Pipeline(Collections.singletonList(filter1));
    ...
    public void singleFilter_EmptyConstructor_AddAll() {
        ...
        Pipeline pipeline = new Pipeline();
        pipeline.addAll(Collections.singletonList(filter1));
    ...
    public void multipleFilter_ArrayConstructor() {
        ...
        // then
        verify(filter1).apply(Mockito.any(BufferedImage.class));
        verify(filter2).apply(Mockito.any(BufferedImage.class));
    }
    ...
    public void filterOrderForTwo() {
        ...
        ImageFilter one = img1 -> {
            order.add(1);
            return img1;
        };

        ImageFilter two = img12 -> {
            order.add(2);
            return img12;
        };
