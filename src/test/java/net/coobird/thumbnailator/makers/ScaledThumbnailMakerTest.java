...
public class ScaledThumbnailMakerTest {
    ...
    public void verifyResizerFactoryBeingCalled() {
        ...
        when(resizerFactory.getResizer(Mockito.any(Dimension.class), Mockito.any(Dimension.class)))
        ...
        verify(spyResizer).resize(Mockito.eq(img), Mockito.any(BufferedImage.class));
    }
